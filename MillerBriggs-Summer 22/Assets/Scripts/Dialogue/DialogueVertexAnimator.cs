...
public class DialogueVertexAnimator
{
    ...
    private float secondsPerCharStartVal = 150; 
    private float secondsPerCharacterVal_1 = 1f, secondsPerCharacterVal_2 = 150f;
    ...
    {
        secondsPerCharacterVal_1 = 1f;
        secondsPerCharacterVal_2 = secondsPerCharStartVal; 

        textAnimating = true;
        secondsPerCharacter = secondsPerCharacterVal_1 / secondsPerCharacterVal_2;
